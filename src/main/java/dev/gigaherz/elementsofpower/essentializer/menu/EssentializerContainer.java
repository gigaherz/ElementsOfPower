        ...
        extends AbstractContainerMenu
{
    ...
    public static MenuType<EssentializerContainer> TYPE;
    ...
    public EssentializerContainer(int id, Inventory playerInventory)
    {
    ...
    public EssentializerContainer(int id, EssentializerBlockEntity tileEntity, Inventory playerInventory)
    {
        this(id, playerInventory, tileEntity.getInventory(), tileEntity);
    }

    private EssentializerContainer(int id, Inventory playerInventory, IItemHandler inv, IMagicAmountHolder magicHolder)
    {
        super(TYPE, id);
