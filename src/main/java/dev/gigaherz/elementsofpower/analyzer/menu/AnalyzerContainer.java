...
public class AnalyzerContainer extends AbstractContainerMenu
{
    ...
    public static MenuType<AnalyzerContainer> TYPE;
    ...
    public AnalyzerContainer(int id, Inventory playerInventory, FriendlyByteBuf extraData)
    {
        this(id, playerInventory, extraData.readInt());
    }

    public AnalyzerContainer(int id, Inventory playerInventory, int slotNumber)
    {
        super(TYPE, id);
