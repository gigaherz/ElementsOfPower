...
public class GuiEssentializer extends ContainerScreen<ContainerEssentializer>
{
    ...
    public GuiEssentializer(ContainerEssentializer container, PlayerInventory playerInventory, ITextComponent title)
    {
    ...
    private void drawOrbTooltips(int mx, int my)
    {
        ...
        for (int i = 0; i < MagicAmounts.ELEMENTS; i++)
        {
            ...
            tooltip.add(TextFormatting.GRAY + ElementsOfPowerMod.prettyNumberFormatter2.format(am.get(i)) + " / " + TileEssentializer.MaxEssentializerMagic);
